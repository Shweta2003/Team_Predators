  ...
  return (
    <div className={classes.body}>
      <div className={classes.main}>
        <div className={classes.perm}>
            ...
            <p className={classes.p}>BAJA SAE is an inter collegiate off-road competition run by the Society of Automotive Engineers. It challenges engineering students to design, build and race an off-road vehicle that can withstand the toughest elements of rough terrain.</p>
            <button className={classes.btn} onClick={() => navigate('./achievements')}>Learn More</button>
        </div>
    </div>
    <div className={classes.main}>
        <div className={classes.perm}>
    ...
    <div className={classes.main}>
        <div className={classes.perm}>
            ...
            <p className={classes.p1}>Dreams aspirations are not easily obtained but one of the hardest things to do is to keep going is to keep chasing.Being a Predator we will definitely strive for success but we want you to be our support while carrying this responsibility.Contribute to a cause, Be a Predator with us.</p>
